...
contract PresaleRegister is Ownable {
    ...
    */
     ...
     * @return bool is true is address_investor 
     */
...
contract Crowdsale {
    ...
    function Crowdsale(uint256 _startTime, uint256 _endTime, address _wallet, shokoCASTToken _tokenAddress) {
...
/**
 * @title shokoCAST token pre-sale
...
contract PublicPresale is FinalizableCrowdsale {
     ...
     */
    function PublicPresale(uint256 _startTime, uint256 _endTime, address _wallet, shokoCASTToken _token, PresaleRegister _register)
    FinalizableCrowdsale()
    Crowdsale(_startTime, _endTime, _wallet, _token)
    {
        register = _register;
        toBeSold = 1990876750*100000000;
        price = 73570240;
    }
